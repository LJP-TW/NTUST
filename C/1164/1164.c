...
void makeMatrix(int *num_table, int row, int col, int nowR, int nowC);
...
int main()
{
	...
	while(scanf(" %d %d", &row, &col) != EOF)
	{
		...
		char *chr_table = malloc(row * col * sizeof(char));
		...
		*/
		...
		++queue_front;
		makeMatrix(num_table, row, col, queueR[queue_front], queueC[queue_front]);
